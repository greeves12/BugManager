...
public class ConfigEditor {
    ...
    public static void createConfig(){
        ItemStack stack = new ItemStack(Material.WHITE_WOOL, 1, (byte) 3);
        ItemMeta meta = stack.getItemMeta();
        meta.setDisplayName("§aReminder Interval");
        stack.setItemMeta(meta);
        configInv.setItem(0, stack);

        ItemStack two = new ItemStack(Material.WHITE_WOOL, 1, (byte) 6);
        ...
        ItemStack joinMes = new ItemStack(Material.WHITE_WOOL, 1, (byte) 14);
        ...
        ItemStack cooldown = new ItemStack(Material.WHITE_WOOL, 1, (byte) 5);
        ...
        ItemStack tba = new ItemStack(Material.WHITE_WOOL,1, (byte) 15);
    ...
    public static void createReminder(){
        ...
        ItemStack two = new ItemStack(Material.ENDER_EYE, 1);
        ItemMeta twoMeta = two.getItemMeta();
        twoMeta.setDisplayName("§bAdd §55");
        two.setItemMeta(twoMeta);
        ConfigEditor.configReminder.setItem(9, two);

        ItemStack three = new ItemStack(Material.ENDER_EYE, 1);
        ...
        ItemStack four = new ItemStack(Material.ENDER_EYE, 1);
        ...
        ItemStack five = new ItemStack(Material.ENDER_EYE, 1);
        ...
        ItemStack seven = new ItemStack(Material.ENDER_EYE, 1);
        ...
        ItemStack eight = new ItemStack(Material.ENDER_EYE, 1);
        ...
        ItemStack nine = new ItemStack(Material.ENDER_EYE, 1);
        ...
        ItemStack ten = new ItemStack(Material.ENDER_EYE, 1);
    ...
    public static void createUpdater(){
        ...
        ItemStack on = new ItemStack(Material.ENDER_EYE, 1);
        ...
        ItemStack off = new ItemStack(Material.ENDER_EYE, 1);
